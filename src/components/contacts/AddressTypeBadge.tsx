...
export default function AddressTypeBadge({ type }: { type: AddressType }) {
  return (
    <span className="inline-flex min-w-16 shrink-0 justify-center rounded-full border border-border bg-secondary px-2 py-0.5 text-[11px] font-medium uppercase tracking-wide text-secondary-foreground">
